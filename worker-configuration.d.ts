/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: de818461d3c70c4e312285eb0edbfcb2)
// Runtime types generated with workerd@1.20260623.1 2025-09-15 
interface __BaseEnv_CloudflareBindings {
	ANALYTICS_BACKUPS: R2Bucket;
	FAILED_CLICK_ARCHIVES: R2Bucket;
	CLICK_EVENTS: Queue;
	CLICK_EVENTS_FAILED: Queue;
	...
	OPS_ALERTS_ENABLED: "false" | "true";
	OPS_ALERT_TIMEZONE: "Asia/Kolkata";
	WORKER_VERSION: "dev" | "prod";
	CLICK_EVENTS_QUEUE_NAME: "ndle-click-events-dev" | "ndle-click-events";
	CLICK_EVENTS_FAILED_QUEUE_NAME: "ndle-click-events-failed-dev" | "ndle-click-events-failed";
	SHORT_LINK_HOSTS: "dev.ndle.fyi,www.dev.ndle.fyi" | "ndle.fyi,www.ndle.fyi";
}
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		OPS_ALERT_TIMEZONE: "Asia/Kolkata";
		WORKER_VERSION: "dev";
		CLICK_EVENTS_QUEUE_NAME: "ndle-click-events-dev";
		CLICK_EVENTS_FAILED_QUEUE_NAME: "ndle-click-events-failed-dev";
		SHORT_LINK_HOSTS: "dev.ndle.fyi,www.dev.ndle.fyi";
	}
